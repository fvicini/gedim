...
{
  // ***************************************************************************
  vector<string> StringsUtilities::Split(const string& stringToSplit,
  ...
  // ***************************************************************************
  char StringsUtilities::FindSeparator(const string& stringToSearch,
                                       const string& keyOne,
                                       const string& keyTwo)
  {
    char separator;
  ...
  // ***************************************************************************
  template<>
  char StringsUtilities::Parse<char>(const string& objectString)
  {
    return objectString[0];
  }
  // ***************************************************************************
  template<>
  int StringsUtilities::Parse<int>(const string& objectString)
  {
    return std::stoi(objectString);
  }
  // ***************************************************************************
  template<>
  unsigned int StringsUtilities::Parse<unsigned int>(const string& objectString)
  {
    return std::stoi(objectString);
  }
  // ***************************************************************************
  template<>
  float StringsUtilities::Parse<float>(const string& objectString)
  {
    return std::stof(objectString);
  }
  // ***************************************************************************
  template<>
  double StringsUtilities::Parse<double>(const string& objectString)
  {
    return std::stod(objectString);
  }
  // ***************************************************************************
  template<>
  string StringsUtilities::Parse<string>(const string& objectString)
  {
    return objectString;
  }
  // ***************************************************************************
  template<>
  bool StringsUtilities::Parse<bool>(const string& objectString)
  {
  ...
  template<>
  vector<int> StringsUtilities::Parse<vector<int>>(const string& objectString)
  {
  ...
  /// @note Supported vector separator are {',' ';' ' '}
  template<>
  vector<unsigned int> StringsUtilities::Parse<vector<unsigned int>>(const string& objectString)
  {
  ...
  /// @note Supported vector separator are {',' ';' ' '}
  template<>
  vector<double> StringsUtilities::Parse<vector<double>>(const string& objectString)
  {
  ...
  /// @note Supported vector separator are {',' ';' ' '}
  template<>
  set<unsigned int> StringsUtilities::Parse<set<unsigned int>>(const string& objectString)
  {
