...
// ***************************************************************************
template<typename Eigen_ArrayType, typename Eigen_SparseArrayType>
void Eigen_LUSolver<Eigen_ArrayType, Eigen_SparseArrayType>::Initialize(const IArray& rightHandSide,
                                                                        IArray& solution)
{
    _rightHandSide = &rightHandSide;
    _solution = &solution;
...
// ***************************************************************************
template<typename Eigen_ArrayType, typename Eigen_SparseArrayType>
void Eigen_LUSolver<Eigen_ArrayType, Eigen_SparseArrayType>::Solve() const
{
...
// ***************************************************************************
template<typename Eigen_ArrayType, typename Eigen_SparseArrayType>
void Eigen_LUSolver<Eigen_ArrayType, Eigen_SparseArrayType>::Solve(const IArray& rightHandSide, IArray& solution) const
{
