...
// ***************************************************************************
std::vector<IntersectorMesh3DSegment::IntersectionMesh::IntersectionMeshSegment> IntersectorMesh3DSegment::CreateIntersectionSegments(const Gedim::IMeshDAO& mesh3D,
                                                                                                                                      const std::vector<IntersectionMesh::IntersectionMeshPoint>& mesh1D_points) const
{
    ...
    for (unsigned int s = 0; s < mesh1D_segments.size(); s++)
    {
        ...
        for(unsigned int c = 0; c < segment_cell3Ds.size(); c++)
        {
            ...
            if(mesh1D_points[s].Positions[local_id_cell3D_origin].Type == GeometryUtilities::PointPolyhedronPositionResult::Types::Inside
                || mesh1D_points[s + 1].Positions[local_id_cell3D_end].Type == GeometryUtilities::PointPolyhedronPositionResult::Types::Inside)
            {
            ...
            if(mesh1D_points[s].Positions[local_id_cell3D_origin].Type == GeometryUtilities::PointPolyhedronPositionResult::Types::BorderFace
                || mesh1D_points[s + 1].Positions[local_id_cell3D_end].Type == GeometryUtilities::PointPolyhedronPositionResult::Types::BorderFace)
            {
            ...
            else if(mesh1D_points[s].Positions[local_id_cell3D_origin].Type == GeometryUtilities::PointPolyhedronPositionResult::Types::BorderEdge
                     || mesh1D_points[s + 1].Positions[local_id_cell3D_end].Type == GeometryUtilities::PointPolyhedronPositionResult::Types::BorderEdge)
            {
                GeometryUtilities::PointPolyhedronPositionResult first_position;
                GeometryUtilities::PointPolyhedronPositionResult second_position;

                if(mesh1D_points[s].Positions[local_id_cell3D_origin].Type == GeometryUtilities::PointPolyhedronPositionResult::Types::BorderEdge)
                {
                    first_position = mesh1D_points[s].Positions[local_id_cell3D_origin];
                    second_position = mesh1D_points[s + 1].Positions[local_id_cell3D_end];
                }
            ...
            else if(mesh1D_points[s].Positions[local_id_cell3D_origin].Type == GeometryUtilities::PointPolyhedronPositionResult::Types::BorderVertex
                     && mesh1D_points[s + 1].Positions[local_id_cell3D_end].Type == GeometryUtilities::PointPolyhedronPositionResult::Types::BorderVertex)
            {

                GeometryUtilities::PointPolyhedronPositionResult first_position = mesh1D_points[s].Positions[local_id_cell3D_origin];
                GeometryUtilities::PointPolyhedronPositionResult second_position = mesh1D_points[s + 1].Positions[local_id_cell3D_end];
                                                                                                                                       ...
                                                                                                                                       const unsigned int starting_cell3D_index) const
{
    ...
    {
        unsigned int c = 0;
        std::vector<GeometryUtilities::PointPolyhedronPositionResult> segment_origin_position(intersection.second.Cell3DIds.size());
        for(unsigned int c3D_index: intersection.second.Cell3DIds)
        {
            ...
            segment_origin_position[c++] = geometryUtilities.PointPolyhedronPosition(segmentOrigin + intersection.first * (segmentEnd - segmentOrigin),
                                                                                     cell3D_faces,
                                                                                     cell3D_faces_3D_vertices,
                                                                                     cell3D_faces_2D_vertices,
                                                                                     cell3D_faces_normal,
...
{
    const IntersectorMesh3DSegment::FindSegmentStartingCell3DResult segment_starting_cell3D = FindSegmentStartingCell3D(segmentOrigin,
                                                                                                                        segmentEnd,
                                                                                                                        mesh3D,
                                                                                                                        mesh3D_geometricData);
            ...
            {
                {
                    ...
                    { segment_starting_cell3D.Position }
                },
                {
                    1.0,
                    { segment_starting_cell3D.StartingCell3DIndex },
