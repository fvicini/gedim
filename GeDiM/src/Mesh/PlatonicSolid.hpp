...
public:
    ...
    PlatonicSolid(const GeometryUtilities& geometryUtilities,
                  const MeshUtilities &meshUtilities):
    ...
    GeometryUtilities::Polyhedron tetrahedron() const
    {
        ...
        polyhedron.Faces[0] << 0, 1, 2,
            0, 1, 2;

        polyhedron.Faces[1].resize(2, 3);
        polyhedron.Faces[1] << 0, 2, 3,
            2, 3, 4;

        polyhedron.Faces[2].resize(2, 3);
        polyhedron.Faces[2] << 0, 3, 1,
            4, 5, 0;

        polyhedron.Faces[3].resize(2, 3);
        polyhedron.Faces[3] << 3, 2, 1,
            3, 1, 5;
    ...
    GeometryUtilities::Polyhedron hexahedron() const
    {
        ...
        polyhedron.Faces[0] << 3, 2, 1, 0,
            2, 1, 0, 3;

        polyhedron.Faces[1].resize(2, 4);
        polyhedron.Faces[1] << 2, 6, 5, 1,
            4, 5, 6, 1;

        polyhedron.Faces[2].resize(2, 4);
        polyhedron.Faces[2] << 5, 6, 7, 4,
            5, 7, 8, 9;

        polyhedron.Faces[3].resize(2, 4);
        polyhedron.Faces[3] << 0, 4, 7, 3,
            10, 8, 11, 3;

        polyhedron.Faces[4].resize(2, 4);
        polyhedron.Faces[4] << 3, 7, 6, 2,
            11, 7, 4, 2;

        polyhedron.Faces[5].resize(2, 4);
        polyhedron.Faces[5] << 1, 5, 4, 0,
            6, 9, 10, 0;
    ...
    GeometryUtilities::Polyhedron icosahedron() const
    {
        ...
        polyhedron.Faces[0].resize(2, 3);
        polyhedron.Faces[0] << 2, 1, 0,
            0, 1, 2;

        polyhedron.Faces[1].resize(2, 3);
        polyhedron.Faces[1] << 1, 2, 3,
            0, 3, 4;

        polyhedron.Faces[2].resize(2, 3);
        polyhedron.Faces[2] << 5, 4, 3,
            5, 6, 7;

        polyhedron.Faces[3].resize(2, 3);
        polyhedron.Faces[3] << 4, 8, 3,
            8, 9, 6;

        polyhedron.Faces[4].resize(2, 3);
        polyhedron.Faces[4] << 7, 6, 0,
            10, 11, 12;

        polyhedron.Faces[5].resize(2, 3);
        polyhedron.Faces[5] << 6, 9, 0,
            13, 14, 11;

        polyhedron.Faces[6].resize(2, 3);
        polyhedron.Faces[6] << 11, 10, 4,
            15, 18, 19;

        polyhedron.Faces[7].resize(2, 3);
        polyhedron.Faces[7] << 10, 11, 6,
            15, 16, 17;

        polyhedron.Faces[8].resize(2, 3);
        polyhedron.Faces[8] << 9, 5, 2,
            20, 21, 22;

        polyhedron.Faces[9].resize(2, 3);
        polyhedron.Faces[9] << 5, 9, 11,
            20, 23, 24;

        polyhedron.Faces[10].resize(2, 3);
        polyhedron.Faces[10] << 8, 7, 1,
            25, 26, 27;

        polyhedron.Faces[11].resize(2, 3);
        polyhedron.Faces[11] << 7, 8, 10,
            25, 28, 29;

        polyhedron.Faces[12].resize(2, 3);
        polyhedron.Faces[12] << 2, 5, 3,
            21, 7, 3;

        polyhedron.Faces[13].resize(2, 3);
        polyhedron.Faces[13] << 8, 1, 3,
            27, 4, 9;

        polyhedron.Faces[14].resize(2, 3);
        polyhedron.Faces[14] << 9, 2, 0,
            22, 2, 14;

        polyhedron.Faces[15].resize(2, 3);
        polyhedron.Faces[15] << 1, 7, 0,
            26, 12, 1;

        polyhedron.Faces[16].resize(2, 3);
        polyhedron.Faces[16] << 11, 9, 6,
            23, 13, 16;

        polyhedron.Faces[17].resize(2, 3);
        polyhedron.Faces[17] << 7, 10, 6,
            29, 17, 10;

        polyhedron.Faces[18].resize(2, 3);
        polyhedron.Faces[18] << 5, 11, 4,
            24, 19, 5;

        polyhedron.Faces[19].resize(2, 3);
        polyhedron.Faces[19] << 10, 8, 4,
            28, 8, 18;
